...
- Tốt nhất là bạn nên có hiểu biết về khái niệm về tất cả các thuật ngữ thiết yếu thường gặp phải trong thiết kế hệ thống. Chúng ta cần biết các khái niệm về khả năng mở rộng (ngang & dọc), bộ nhớ đệm, cân bằng tải, phân vùng dữ liệu, cơ sở dữ liệu, mạng, giao thức, sharding,... và nhiều thứ khác nữa

Tương tự, chúng ta cần cân nhắc sự cân bằng khi xem xét chức năng cốt lõi của ứng dụng mà chúng ta đang thiết kế. Tuỳ vào yêu cầu, chúng ta cần quyết định: độ trễ với thông lượng, hiệu suất với khả năng mở rộng, tính nhất quán với tính khả dụng,...
...
Forward Proxy hoạt động như một mặt nạ cho máy khách và ẩn danh tính của máy khách khỏi máy chủ, ví dụ: VPN. 

Tương tự, Reverse Proxy hoạt động như một mặt nạ cho máy chủ và ẩn danh tính của máy chủ khỏi phản hồi đi kèm, ví dụ: Load Balancer.
...
**Cơ sở dữ liệu phi quan hệ (NoSQL)** có cấu trúc linh hoạt, tức là chúng ít cứng nhắc hơn. Dữ liệu được lưu trữ theo cách phi cấu trúc và các cơ sở dữ liệu này thường được sử dụng trong các dịch vụ yêu cầu tốc độ cao và được phân phối. Ví dụ: Cassandra, Redis, ...
...
Định lý CAP là một trong những khái niệm thiết yếu cần thiết cho việc thiết kế các hệ thống dữ liệu dùng chung được nối mạng. Định lý CAP là một khái niệm thiết yếu giúp tạo ra sự cân bằng giữa ba chức năng khả dụng, dựa trên trường hợp sử dụng duy nhất mà chúng ta cần cho hệ thống của mình:

- **Tính nhất quán (Consistency):** Nhất quán có nghĩa là mọi thứ sẽ được phối hợp một cách nhịp nhàng và được đồng bộ hóa thích hợp. Tính nhất quán đảm bảo rằng hệ thống phải duy trì sự nhất quán và trả về kết quả sao cho bất kỳ thao tác đọc nào cũng phải ứng với thao tác ghi thường xuyên nhất.
...
Thiết kế Hệ thống là một kỹ năng cần thiết phải có và không kém phần quan trọng theo quan điểm phỏng vấn tại hầu hết các công ty công nghệ hàng đầu. Một người cần phải nhận thức rõ ràng về tất cả những vấn đề khi thiết kế bất kỳ hệ thống nào. Trong bài viết này, chúng tôi đã cố gắng đề cập đến tất cả các khái niệm cơ bản cần thiết để bắt đầu. Chúng tôi hy vọng sau khi đọc blog này, bây giờ bạn sẽ quen thuộc với những kiến thức cơ bản về hệ thống.